...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button task_8=findViewById(R.id.button9);

        task_8.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent task8=new Intent(MainActivity.this,task_8.class);
                startActivity(task8);
            }
        });

        Button task_9=findViewById(R.id.button11);

        task_9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent task9=new Intent(MainActivity.this,task_9.class);
                startActivity(task9);
            }
        });


        Button task_10=findViewById(R.id.button13);

        task_10.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent task10=new Intent(MainActivity.this,task_10.class);
                startActivity(task10);
            }
        });
    }
